...
Developed and maintained by [Felix Gündling](https://github.com/felixguendling).
...
And then include `cista.h` as follows:
```c
#include "node_modules/cista.cxx/cista.h"
```
...
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/cista.cxx)
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/felixguendling/cista)
